...
function RegisterPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email: data.email,
            ...
            const { data: tenant, error: tenantError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tenants').insert({
            ...
            const { data: org, error: orgError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('organizations').insert({
                tenant_id: tenant.id,
                name: data.businessName,
            ...
            const { error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
                id: authData.user?.id,
                tenant_id: tenant.id,
                email: data.email,
            ...
            const { error: whError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('warehouses').insert({
                tenant_id: tenant.id,
                organization_id: org.id,
            ...
            // 6. Create branch
            const { error: branchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('branches').insert({
                tenant_id: tenant.id,
            ...
            if (data.accountType === "vendor") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('supplier_profiles').insert({
                    tenant_id: tenant.id,
                    organization_id: org.id,
                    business_name: data.businessName
                });
...
//# sourceMappingURL=_31147b._.js.map