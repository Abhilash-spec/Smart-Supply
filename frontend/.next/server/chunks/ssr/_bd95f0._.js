...
"[project]/app/(superadmin)/superadmin/tenants/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SuperAdminTenantsPage() {
    ...
    const [formSlug, setFormSlug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [formTier, setFormTier] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("starter");
    const [formStatus, setFormStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("active");
    ...
    async function fetchTenants() {
        try {
            setLoading(true);
            setError(null);
            const { data, error: fetchErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tenants').select('*').order('created_at', {
                ascending: false
            });
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingTenant) {
                // Update
                const { error: updateErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tenants').update({
                    name: formName,
                    slug: formSlug,
                    tier: formTier,
                    status: formStatus,
                ...
                // Insert
                const { error: insertErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tenants').insert({
                    name: formName,
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            setLoading(true);
            const { error: deleteErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('tenants').delete().eq('id', id);
...
"[project]/app/(superadmin)/superadmin/tenants/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_bd95f0._.js.map