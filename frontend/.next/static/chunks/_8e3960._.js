(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_8e3960._.js", {
...
"[project]/app/(vendor)/vendor/catalog/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VendorCatalogPage() {
    ...
    const [supplierId, setSupplierId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Form State
    ...
    const [formSku, setFormSku] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [formPrice, setFormPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    async function fetchProducts() {
        try {
            setLoading(true);
            setError(null);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$vendor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVendorCatalog"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (editingProduct) {
                // Update
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$vendor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateVendorCatalogItem"])(editingProduct.id, {
                    name: formName,
                    sku: formSku,
                    price: parseFloat(formPrice) || 0
                });
                if (!res.success) throw new Error(res.error);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Product updated successfully");
            } else {
                // Insert
                if (!tenantId || !supplierId) throw new Error("Could not detect Supplier context. Contact Admin.");
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$vendor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addVendorCatalogItem"])({
                    tenantId,
                    supplierId,
                    name: formName,
                ...
                if (!res.success) throw new Error(res.error);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Product added to catalog");
            }
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$vendor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteVendorCatalogItem"])(id);
            if (!res.success) throw new Error(res.error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Product removed");
            fetchProducts();
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Failed to delete product.");
            setLoading(false);
        }
    };
...
_s(VendorCatalogPage, "3hcdPzTIcQ6B3ah3wqh+7Ic/zH8=");
_c = VendorCatalogPage;
var _c;
__turbopack_refresh__.register(_c, "VendorCatalogPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/(vendor)/vendor/catalog/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_8e3960._.js.map