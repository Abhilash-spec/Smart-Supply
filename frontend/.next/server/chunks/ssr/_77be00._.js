...
"[project]/app/system/login/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SystemLoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError(null);
        try {
            const { data, error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
...
"[project]/app/system/login/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_77be00._.js.map